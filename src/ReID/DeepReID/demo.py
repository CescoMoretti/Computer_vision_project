...
parser.add_argument('--test_dir',default='C:\Market-1501-v15.09.15\pytorch',type=str, help='./test_data')
...
fig.savefig("C:\Computer_vision_project\src\ReID\DeepReID\TestReID\show.png")
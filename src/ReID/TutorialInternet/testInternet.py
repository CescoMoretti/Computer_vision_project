...
config_path = os.path.join('C:\Computer_vision_project\src\ReID\DeepReID\Result','opts.yaml')
...
data_dir = "C:\Market-1501-v15.09.15\pytorch"
...
def load_network(network):
    save_path = os.path.join('C:\Computer_vision_project\src\ReID\DeepReID\Result','net_%s.pth'%opt.which_epoch)
